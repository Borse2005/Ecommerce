        ...
        <div class="grid grid-cols-5 gap-6">
            <div class="col-span-6 sm:col-span-3">
                ...
                <select name="category_id" id="category_id" wire:model="selectedCountry"
                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('category_id') border-red-500 @enderror">
            ...
            <div class="grid grid-cols-5 gap-6">
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <select name="subcategory_id" id="subcategory_id" wire:model="selectedSubcategory"
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('subcategory_id') border-red-500 @enderror">
