                ...
                <div class="py-12">
                    <div class="max-w-7xl mx-auto  sm:px-6 lg:px-8">
                        <div class="flex flex-wrap">
                            <div class="p-6 max-w-sm mx-auto bg-white rounded-md shadow-lg flex items-center space-x-4">
                                <div style="padding-right: 62px; padding-left: 62px">
                                    <div class="text-xl font-medium text-black text-center ">{{ count($user) }}
                                    </div>
                            ...
                            <div class="p-6  max-w-sm mx-auto bg-white rounded-md shadow-lg flex items-center space-x-4">
                                <div style="padding-right: 45px; padding-left: 45px">
                                    <div class="text-xl font-medium text-black text-center ">{{ count($product) }}
                                    </div>
                        ...
                        <div class="flex flex-wrap mt-10">
                            ...
                            <div class="p-6 max-w-sm mx-auto bg-white rounded-md shadow-lg flex items-center space-x-4">
                                <div style="padding-right: 50px; padding-left: 50px">
                                    <div class="text-xl font-medium text-black text-center ">{{ count($order) }}</div>
