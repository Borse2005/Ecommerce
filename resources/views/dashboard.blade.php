                ...
                <div class="max-w-7xl mx-auto  sm:px-6 lg:px-8">
                    <div class="flex flex-wrap mb-10">
                        ...
                        <div class="p-6  max-w-sm mx-auto bg-white rounded-md shadow-lg flex items-center space-x-4">
                            ...
                            <div class=" p-9">
                                <div class="text-xl  font-medium text-black text-center text-3xl">{{ count($category) }}</div>
                        ...
                        <div class="p-6 max-w-sm mx-auto bg-white rounded-md shadow-lg flex items-center space-x-4">
                            ...
                            <div style="padding-right: 50px; padding-left: 50px">
                                <div class="text-xl font-medium text-black text-center text-3xl">{{ count($product) }}</div>
                                <p class="text-gray-500 p-0">{{ __("Total Product") }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-wrap mt-10">
                        <div class="p-6 max-w-sm mx-auto bg-white rounded-md shadow-lg flex items-center space-x-4">
                            <div style="padding-right: 62px; padding-left: 62px">
                                <div class="text-xl font-medium text-black text-center text-3xl">{{ count($user) }}</div>
                                ...
                                <div class="ml-12">
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        ...
                                        projects to the next level. Pair them with powerful open source libraries like <a
                                            href="https://laravel.com/docs/billing" class="underline">Cashier</a>, <a
                                            href="https://laravel.com/docs/dusk" class="underline">Dusk</a>, <a
                                            href="https://laravel.com/docs/broadcasting" class="underline">Echo</a>,
                                        <a href="https://laravel.com/docs/horizon" class="underline">Horizon</a>, <a
                                            href="https://laravel.com/docs/sanctum" class="underline">Sanctum</a>, <a
                                            href="https://laravel.com/docs/telescope" class="underline">Telescope</a>,
                                        and more.
                                    </div>
                                </div>
                            </div>
