                ...
                <div class="grid grid-cols-0 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md ">{!! old('description', optional($products ?? null)->description) !!}</textarea>
                    </div>
                </div>
                @error('description')
                    <div class="text-red-500 font-bold mt-2">
