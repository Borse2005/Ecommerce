                ...
                <div class="grid grid-cols-0 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <textarea name="highlight" id="highlight" rows="3"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('highlight') border-red-500 @enderror">{!! old('highlight', optional($products ?? null)->highlight) !!}</textarea>
                    </div>
                </div>
                @error('highlight')
                    <div class="text-red-500 font-bold mt-2">
                ...
                <div class="grid grid-cols-0 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <textarea name="specifications" id="specifications" rows="3"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('specifications') border-red-500 @enderror">{!! old('specifications', optional($products ?? null)->specifications) !!}</textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-0 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('description') border-red-500 @enderror">{!! old('description', optional($products ?? null)->description) !!}</textarea>
                    </div>
                </div>
                @error('description')
                    <div class="text-red-500 font-bold mt-2">
                ...
                <div class="grid grid-cols-0 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="file" name="thumbnail" maxlength="2" id="thumbnail"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block  sm:text-sm border-gray-300  @error('thumbnail') border-red-500 @enderror">
                    </div>
                </div>
                @error('thumbnail')
                    <div class="text-red-500 font-bold mt-2">
